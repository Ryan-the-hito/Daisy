...
4. 关于五阶的亮度，其实并非完全地每 20 分一阶。建议的做法是在亮度升高和亮度降低两个指令集中错开 10 度。这样可以避免环境灯在固定的五阶上来回摆动，无法调至其他亮度。例如，若不错开，那么亮度只会在 0、20、40、60、80 和 100 之间变化，50 度就不可能通过自动方式实现。而如果错开，那么灯可以升高至 60，然后再降至 50。
